...
(function () {
  ...
  // ---------- article catalog ----------
  DN.ARTICLES = [
    { slug:'hzo-stromal-keratitis-zeds-lessons', title:'帶狀疱疹眼疾反覆角膜炎：為什麼停眼藥水 3 個月最危險？', title_en:'Recurrent Stromal Keratitis After HZO — Why the 3 Months After Stopping Steroids Are Riskiest', cat:'research', tag:'角膜炎', tag_en:'Keratitis', date:'2026-05-23' },
